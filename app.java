...
public class app {
	...
	public static String getCargo(int codigo) {
		...
		case 3:
			return "Chefe de Cobran�a";
		case 4:
			return "Chefe de Expedi��o";
		case 5:
			return "Contador";
		case 6:
			return "Gerente de Divis�o";
		case 7:
			return "Escrituario";
		case 8:
			return "Faxineiro";
...
//Menu principal.
	public static void menu() {
		System.out.println("\tBem vindo ao Banco de Funcion�rios");
		System.out.println("\tEscolha uma op��o:");
		System.out.println("01.Cadastrar Funcion�rios:");
		System.out.println("02.Pesquisar Funcion�rios:");
		System.out.println("03.Registro dos Funcion�rios que recebem mais de R$1000,00:");
		System.out.println("04.Registro dos Funcion�rios que recebem menos de R$1000,00:");
		System.out.println("05.Registro dos Funcion�rios que recebem R$1000,00:");
...
//Declaração do método de Cadastro dos 200 funcionários. Não esquecer que eles precisam ter matrícula (identificador), cargo, nome e salário.
	public static void cadastro() {
		...
		while (true) {
			...
			System.out.println("3. Chefe de Cobran�a");
			System.out.println("4. Chefe de Expedi��o");
			System.out.println("5. Contador");
			System.out.println("6. Gerente de Divis�o");
			...
			System.out.println("14. Contador");
...
//Switch que roda os métodos de acordo com a opção escolhida.
        ...
        default:
            System.out.println("Op��o inv�lida. Digite um n�mero de um � seis.");
        }
}   while(opcao != 0);
}
}